    ...
    public partial class Form1 : Form
    {
        ...
        private void TallennaBT_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Uutta opiskelijaa ei pystytty lisäämään", "Opiskelijan lysäys", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            TietotauluDG.DataSource = opiskelija.haeOpiskelijat();
        }
        ...
        private void PoistaBT_Click(object sender, EventArgs e)
        {
            ...
            if (opiskelija.poistaOpiskelijat(ktunnus))
            {
                TietotauluDG.DataSource = opiskelija.haeOpiskelijat();
                MessageBox.Show("Opiskelija poistettu onnistuneesti", "Opiskelija poisto", MessageBoxButtons.OK, MessageBoxIcon.Information);
